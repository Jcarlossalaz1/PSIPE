...
<input type="button" onclick=" location.href='newdocentes.php' " value="Regresar a Docentes" name="boton" /></h2><br><br>        </h2><br><br>        
        
        <img src="images/graficag1.png" /><br><br><br><br>
...
<?php unset($testper1,$testper2,$testper3,$testper4,$testper5,$testper6,$testper7,$testper8,$testper9);       ?>
 ...
 <img src="images/graficag2.png" /><br><br><br><br>

<h3><div align="center"> Actitud cognitiva</h3><br><br>
<hr><img src="<?php echo $testact1; ?>" ><br><br>
<h3><div align="center"> Dimension afectiva</h3><br><br>
<hr><img src="<?php echo $testact2; ?>" ><br><br>
<h3><div align="center"> Dimension conativa</h3><br><br>
...
<h3><div align="center"> Kinest&eacutesicos</h3><br><br>
...
<input type="button" onclick=" location.href='newdocentes.php' " value="Regresar a Docentes" name="boton" />
...
<div id="footer">
	<div class="fcenter">
		<div class="fleft"><p>Copyright UPVM 2016</p></div><div class="fright"></div><div class="fclear"></div>
	</div>
</div>
