...
if(!isset($_SESSION['matricula'])) 
{
  ...
  $sql = "SELECT autoestima, sociable, asertividad,  autoeficacia,impulsividad,creencia_personal,conducta,depresion,ansiedad_en_examenes,total FROM grafica WHERE matricula='" .$matricula."'";
...
mysql_free_result($result);
	   ...
	   $chart->render("images/grafical.png");
...
mysql_free_result($result2);
	   ...
	   $chart2->render("images/grafical2.png");
...
$_SESSION['test3p1']=$visual;
 ...
 $_SESSION['test3p5']=$viayki;
	  ...
	  mysql_free_result($result3);
	   ...
	   $chart3->render("images/grafical3.png");
unset($visual,$kinestesico,$auditivo,$viau,$viayki,$result3);

								
	   	   
	   
		header('location: ejecutaal.php');
