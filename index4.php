...
<!-- #mainContent -->
	<div id="mainContent">
		<h1>Bienvenido/a SELF-CONFIDENCE de la Universidad Politécnica de Pénjamo</h1><br />
		<p align="justify">

La informacion que podrás consultar te permitirá conocer al grupo y 
alumnos inividualmente en cuanto a su autoestima, estilo de actitud cognitiva y aprendizaje 
que se te han asignado.</p>
	</div>
<!-- / #mainContent -->
	<br class="clearfloat" />
<!-- #footer -->
