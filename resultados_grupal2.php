...
$grupo=$_POST['grupo'];
  ...
  $sql="SELECT AVG(autoestima),AVG(sociable),AVG(asertividad),AVG(autoeficacia),AVG(impulsividad),AVG(creencia_personal),AVG(conducta),AVG(depresion),AVG(ansiedad_en_examenes), AVG(total) FROM grafica WHERE grupo='" .$grupo."'";
...
$_SESSION['test1p2']=$sociable;
 ...
 mysql_free_result($result);
	   ...
	   $chart->SetTitle("Grafica de resultados grupo: $grupo");
	   
	   $chart->render("images/graficag4.png");
...
$_SESSION['test2p3']=$conativos;
 mysql_free_result($result2);
	   ...
	   $chart2->SetTitle("Grafica de resultados grupo: $matricula");
	   
	   $chart2->render("images/graficag5.png");
  ...
  $sql3 = "SELECT AVG(visual), AVG(kinestesico), AVG(auditivo), AVG(viau), AVG(viayki) FROM test_conocimietos WHERE grupo='" .$grupo."'";
  $result3 = mysql_query ($sql3,$conexion3);
 ...
 $_SESSION['test3p5']=$viayki;
	  ...
	  mysql_free_result($result3);
	   ...
	   $chart3->SetTitle("Grafica de resultados grupo: $grupo");
	   
	   $chart3->render("images/graficag6.png");
	   
	   	   unset($visual,$kinestesico,$auditivo,$viau,$viayki,$result3);
	   
		header('location:ejecutag2.php');
